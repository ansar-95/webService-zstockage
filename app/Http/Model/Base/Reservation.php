...
abstract class Reservation implements ActiveRecordInterface
{
    ...
    /**
     * The value for the dateprevuestockage field.
     *
     * @var        DateTime
     */
    protected $dateprevuestockage;

    /**
     * The value for the nbjoursdestockageprevu field.
     *
     * @var        int
     */
    protected $nbjoursdestockageprevu;
    ...
    /**
     * The value for the numclient field.
     *
     * @var        int
     */
    protected $numclient;
    ...
    /**
     * Get the [optionally formatted] temporal [dateprevuestockage] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
     ...
     * @psalm-return ($format is null ? DateTime : string)
     */
    public function getDateprevuestockage($format = null)
    {
        if ($format === null) {
            return $this->dateprevuestockage;
        } else {
            return $this->dateprevuestockage instanceof \DateTimeInterface ? $this->dateprevuestockage->format($format) : null;
        }
    }

    /**
     * Get the [nbjoursdestockageprevu] column value.
     *
     * @return int
     */
    public function getNbjoursdestockageprevu()
    {
        return $this->nbjoursdestockageprevu;
    }
    ...
    /**
     * Get the [numclient] column value.
     *
     * @return int
     */
    ...
    /**
     * Sets the value of [dateprevuestockage] column to a normalized version of the date/time value specified.
     *
     * @param  string|integer|\DateTimeInterface $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\App\Http\Model\Reservation The current object (for fluent API support)
     */
    public function setDateprevuestockage($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->dateprevuestockage !== null || $dt !== null) {
            if ($this->dateprevuestockage === null || $dt === null || $dt->format("Y-m-d") !== $this->dateprevuestockage->format("Y-m-d")) {
                $this->dateprevuestockage = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ReservationTableMap::COL_DATEPREVUESTOCKAGE] = true;
            }
        } // if either are not null

        return $this;
    } // setDateprevuestockage()

    /**
     * Set the value of [nbjoursdestockageprevu] column.
     *
     * @param int $v New value
     * @return $this|\App\Http\Model\Reservation The current object (for fluent API support)
     */
    public function setNbjoursdestockageprevu($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->nbjoursdestockageprevu !== $v) {
            $this->nbjoursdestockageprevu = $v;
            $this->modifiedColumns[ReservationTableMap::COL_NBJOURSDESTOCKAGEPREVU] = true;
        }

        return $this;
    } // setNbjoursdestockageprevu()
    ...
    public function setQuantite($v)
    {
        ...
        if ($this->quantite !== $v) {
            $this->quantite = $v;
            $this->modifiedColumns[ReservationTableMap::COL_QUANTITE] = true;
        }
    ...
    /**
     * Set the value of [numclient] column.
     *
     * @param int $v New value
     * @return $this|\App\Http\Model\Reservation The current object (for fluent API support)
     */
    public function setNumclient($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->numclient !== $v) {
            $this->numclient = $v;
            $this->modifiedColumns[ReservationTableMap::COL_NUMCLIENT] = true;
        }

        if ($this->aUtilisateur !== null && $this->aUtilisateur->getNumutilisateur() !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReservationTableMap::translateFieldName('Datereservation', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->datereservation = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReservationTableMap::translateFieldName('Dateprevuestockage', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->dateprevuestockage = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ReservationTableMap::translateFieldName('Nbjoursdestockageprevu', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nbjoursdestockageprevu = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ReservationTableMap::translateFieldName('Quantite', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantite = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ReservationTableMap::translateFieldName('Etat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->etat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ReservationTableMap::translateFieldName('Numclient', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numclient = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = ReservationTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aUtilisateur !== null && $this->numclient !== $this->aUtilisateur->getNumutilisateur()) {
            $this->aUtilisateur = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_DATEPREVUESTOCKAGE)) {
            $modifiedColumns[':p' . $index++]  = 'datePrevueStockage';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_NBJOURSDESTOCKAGEPREVU)) {
            $modifiedColumns[':p' . $index++]  = 'nbJoursDeStockagePrevu';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_QUANTITE)) {
            $modifiedColumns[':p' . $index++]  = 'quantite';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_ETAT)) {
            $modifiedColumns[':p' . $index++]  = 'etat';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_NUMCLIENT)) {
            $modifiedColumns[':p' . $index++]  = 'numClient';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'dateReservation':
                        $stmt->bindValue($identifier, $this->datereservation ? $this->datereservation->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'datePrevueStockage':
                        $stmt->bindValue($identifier, $this->dateprevuestockage ? $this->dateprevuestockage->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'nbJoursDeStockagePrevu':
                        $stmt->bindValue($identifier, $this->nbjoursdestockageprevu, PDO::PARAM_INT);
                        break;
                    case 'quantite':
                    ...
                    case 'etat':
                        ...
                        break;
                    case 'numClient':
                        $stmt->bindValue($identifier, $this->numclient, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getDateprevuestockage();
                break;
            case 3:
                return $this->getNbjoursdestockageprevu();
                break;
            case 4:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDatereservation(),
            $keys[2] => $this->getDateprevuestockage(),
            $keys[3] => $this->getNbjoursdestockageprevu(),
            $keys[4] => $this->getQuantite(),
            $keys[5] => $this->getEtat(),
            $keys[6] => $this->getNumclient(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setDateprevuestockage($value);
                break;
            case 3:
                $this->setNbjoursdestockageprevu($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDatereservation($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDateprevuestockage($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNbjoursdestockageprevu($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setQuantite($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setEtat($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setNumclient($arr[$keys[6]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_DATEPREVUESTOCKAGE)) {
            $criteria->add(ReservationTableMap::COL_DATEPREVUESTOCKAGE, $this->dateprevuestockage);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_NBJOURSDESTOCKAGEPREVU)) {
            $criteria->add(ReservationTableMap::COL_NBJOURSDESTOCKAGEPREVU, $this->nbjoursdestockageprevu);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_QUANTITE)) {
            $criteria->add(ReservationTableMap::COL_QUANTITE, $this->quantite);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_ETAT)) {
            $criteria->add(ReservationTableMap::COL_ETAT, $this->etat);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_NUMCLIENT)) {
            $criteria->add(ReservationTableMap::COL_NUMCLIENT, $this->numclient);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDateprevuestockage($this->getDateprevuestockage());
        $copyObj->setNbjoursdestockageprevu($this->getNbjoursdestockageprevu());
        $copyObj->setQuantite($this->getQuantite());
        $copyObj->setEtat($this->getEtat());
        $copyObj->setNumclient($this->getNumclient());
    ...
    {
        if ($v === null) {
            $this->setNumclient(NULL);
        } else {
            $this->setNumclient($v->getNumutilisateur());
        }
    ...
    {
        if ($this->aUtilisateur === null && ($this->numclient != 0)) {
            $this->aUtilisateur = ChildUtilisateurQuery::create()->findPk($this->numclient, $con);
    ...
    public function setReservationstockees(Collection $reservationstockees, ConnectionInterface $con = null)
    {
        ...
        foreach ($reservationstockeesToDelete as $reservationstockeeRemoved) {
            $reservationstockeeRemoved->setReservation(null);
        }
    ...
    protected function doAddReservationstockee(ChildReservationstockee $reservationstockee)
    {
        ...
        $reservationstockee->setReservation($this);
    }
    ...
    public function removeReservationstockee(ChildReservationstockee $reservationstockee)
    {
        if ($this->getReservationstockees()->contains($reservationstockee)) {
            ...
            $reservationstockee->setReservation(null);
        }
     ...
     * @return ObjectCollection|ChildReservationstockee[] List of ChildReservationstockee objects
     */
    public function getReservationstockeesJoinPile(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildReservationstockeeQuery::create(null, $criteria);
        $query->joinWith('Pile', $joinBehavior);
    ...
    public function clear()
    {
        ...
        $this->dateprevuestockage = null;
        $this->nbjoursdestockageprevu = null;
        $this->quantite = null;
        $this->etat = null;
        $this->numclient = null;
        $this->alreadyInSave = false;
